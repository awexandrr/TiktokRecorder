...
from TikTokLive.client.web.routes.fetch_room_title import FetchRoomTitleRoute
...
SEND_DEPRECATION_WARNINGS = os.environ.get(
    'SEND_DEPRECATION_WARNINGS', 'true').lower() == 'true'
...
class TikTokWebClient(TikTokHTTPClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.fetch_room_id_from_html: FetchRoomIdLiveHTMLRoute = FetchRoomIdLiveHTMLRoute(
            self)
        self.fetch_room_id_from_api: FetchRoomIdAPIRoute = FetchRoomIdAPIRoute(
            self)
        self.fetch_room_info: FetchRoomInfoRoute = FetchRoomInfoRoute(self)
        self.fetch_room_title: FetchRoomTitleRoute = FetchRoomTitleRoute(self)
        ...
        self.fetch_signed_websocket: FetchSignedWebSocketRoute = FetchSignedWebSocketRoute(
            self)
        ...
        self.fetch_user_unique_id: FetchUserUniqueIdRoute = FetchUserUniqueIdRoute(
            self)
