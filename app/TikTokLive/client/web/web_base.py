...
class TikTokHTTPClient:
    ...
    def __init__(
        ...
        # The URL signer
        self._tiktok_signer: TikTokSigner = TikTokSigner(
            **(signer_kwargs or dict()))
    ...
    def build_url(
        ...
        try:
            ...
            url_params = {param.split("=")[0]: param.split("=")[
                1] for param in url_params}
        except IndexError:
            url_params = {}
    ...
    async def build_request(
       ...
       """
        ...
        request: httpx.Request = client.build_request(
            ...
            cookies=self.cookies,
            headers={**(self.headers if base_headers else {}),
                     **(extra_headers or dict())},
            **kwargs
        )
    ...
    async def request(
            ...
            url: str,
            method: str,
            http_client: Optional[Union[httpx.AsyncClient,
                                        curl_cffi.requests.AsyncSession]] = None,
        ...
        request: httpx.Request = await self.build_request(
            ...
            sign_url=sign_url,
            httpx_client=http_client if isinstance(
                http_client, httpx.AsyncClient) else None,
        ...
        if http_backend == "httpx":
            ...
            if SUPPORTS_CURL_CFFI and isinstance(http_client, curl_cffi.requests.AsyncSession):
                raise ValueError(
                    "Cannot use the curl_cffi client with httpx backend!")
            ...
            if isinstance(http_client, httpx.AsyncClient):
                raise ValueError(
                    "Cannot use the httpx client with curl_cffi backend!")
